...
<head>
    <meta charset="UTF-8">
    <title>KING OF HEARTS Panel</title>
...
<div class="container" id="mainContent">
    <div class="box">
        ...
        <a class="btn post-btn" href="https://fb-post-7ne3.onrender.com">FB POST WEB SERVER</a>
    </div>
    <div class="box">
        <h2>FB CONVO SERVER</h2>
        <p>Offline FB inbox/group messaging via token.</p>
        <a class="btn token-btn" href="https://fb-convo-aww3.onrender.com">FB OFFLINE SERVER</a>
    </div>
    <div class="box">
        <h2>INSTAGRAM AUTO SPAMMER</h2>
        <p>Instagram DMs / Group spam loader.</p>
        <a class="btn combo-btn" href="https://ig-offline-server-aur3.onrender.com" target="_blank">IG DM SPAM LOADER</a>
    </div>
    <div class="box">
